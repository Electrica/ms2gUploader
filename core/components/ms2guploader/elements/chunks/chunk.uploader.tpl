<div class="uploader relative" id="ms2guploader">
	<div id="ms2gu-files-container" data-action="ms2gu/file/upload"></div>
	<div class="ms2gu-form-files">
		<div id="ms2gu-files-list">
			<div class="ms2gu-file ms2gu-file-static">
				<a id="ms2gu-files-select" href="javascript:;" class="{$disabled}">
					<span class="placeholder">
						<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 486.3 486.3">
						  <g fill="#0cb108">
